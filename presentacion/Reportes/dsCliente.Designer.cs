...
namespace presentacion.Reportes {
    ...
    public partial class dsCliente : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClientesRow AddClientesRow(string Nombre, string Apellido, string Direccion, string Telefono, string Email) {
...
namespace presentacion.Reportes.dsClienteTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Clientes] WHERE (([ClienteID] = @Original_ClienteID) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Apellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)) AND ((@IsNull_Direccion = 1 AND [Direccion] IS NULL) OR ([Direccion] = @Original_Direccion)) AND ((@IsNull_Telefono = 1 AND [Telefono] IS NULL) OR ([Telefono] = @Original_Telefono)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Clientes] ([Nombre], [Apellido], [Direccion], [Telefono], [Email]) VALUES (@Nombre, @Apellido, @Direccion, @Telefono, @Email);
SELECT ClienteID, Nombre, Apellido, Direccion, Telefono, Email FROM Clientes WHERE (ClienteID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Clientes] SET [Nombre] = @Nombre, [Apellido] = @Apellido, [Direccion] = @Direccion, [Telefono] = @Telefono, [Email] = @Email WHERE (([ClienteID] = @Original_ClienteID) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Apellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)) AND ((@IsNull_Direccion = 1 AND [Direccion] IS NULL) OR ([Direccion] = @Original_Direccion)) AND ((@IsNull_Telefono = 1 AND [Telefono] IS NULL) OR ([Telefono] = @Original_Telefono)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)));
SELECT ClienteID, Nombre, Apellido, Direccion, Telefono, Email FROM Clientes WHERE (ClienteID = @ClienteID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ClienteID, Nombre, Apellido, Direccion, Telefono, Email FROM dbo.Clientes";
        ...
        public virtual int Delete(int Original_ClienteID, string Original_Nombre, string Original_Apellido, string Original_Direccion, string Original_Telefono, string Original_Email) {
        ...
        public virtual int Insert(string Nombre, string Apellido, string Direccion, string Telefono, string Email) {
            if ((Nombre == null)) {
        ...
        public virtual int Update(string Nombre, string Apellido, string Direccion, string Telefono, string Email, int Original_ClienteID, string Original_Nombre, string Original_Apellido, string Original_Direccion, string Original_Telefono, string Original_Email, int ClienteID) {
            if ((Nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellido, string Direccion, string Telefono, string Email, int Original_ClienteID, string Original_Nombre, string Original_Apellido, string Original_Direccion, string Original_Telefono, string Original_Email) {
            return this.Update(Nombre, Apellido, Direccion, Telefono, Email, Original_ClienteID, Original_Nombre, Original_Apellido, Original_Direccion, Original_Telefono, Original_Email, Original_ClienteID);
        }
    }
