...
namespace presentacion.Reportes {
    ...
    public partial class DsReporte : global::System.Data.DataSet {
        ...
        public partial class AutoresDataTable : global::System.Data.TypedTableBase<AutoresRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AutoresRow AddAutoresRow(string Nombre, string Apellido) {
        ...
        public partial class AutoresRow : global::System.Data.DataRow {
            ...
            public string Apellido {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Apellido\' de la tabla \'Autores\' es DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsApellidoNull() {
                return this.IsNull(this.tableAutores.ApellidoColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetApellidoNull() {
                this[this.tableAutores.ApellidoColumn] = global::System.Convert.DBNull;
            }
        }
    ...
    public partial class AutoresTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Autores] WHERE (([AutorID] = @Original_AutorID) AND ((@IsNull_" +
                ...
                "_Apellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Autores] ([Nombre], [Apellido]) VALUES (@Nombre, @Apellido);\r\n" +
                "SELECT AutorID, Nombre, Apellido FROM Autores WHERE (AutorID = SCOPE_IDENTITY())" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Autores] SET [Nombre] = @Nombre, [Apellido] = @Apellido WHERE (([AutorID] = @Original_AutorID) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Apellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)));
SELECT AutorID, Nombre, Apellido FROM Autores WHERE (AutorID = @AutorID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT AutorID, Nombre, Apellido FROM dbo.Autores";
        ...
        public virtual int Fill(DsReporte.AutoresDataTable dataTable) {
        ...
        public virtual DsReporte.AutoresDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DsReporte.AutoresDataTable dataTable = new DsReporte.AutoresDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DsReporte.AutoresDataTable dataTable) {
        ...
        public virtual int Delete(int Original_AutorID, string Original_Nombre, string Original_Apellido) {
        ...
        public virtual int Update(string Nombre, string Apellido, int Original_AutorID, string Original_Nombre, string Original_Apellido, int AutorID) {
            if ((Nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellido, int Original_AutorID, string Original_Nombre, string Original_Apellido) {
            return this.Update(Nombre, Apellido, Original_AutorID, Original_Nombre, Original_Apellido, Original_AutorID);
        }
    }
