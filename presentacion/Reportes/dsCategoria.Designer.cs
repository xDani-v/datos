...
namespace presentacion.Reportes.dsCategoriaTableAdapters {
    ...
    public partial class CategoriasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Categorias] SET [NombreCategoria] = @NombreCategoria WHERE (([CategoriaID] = @Original_CategoriaID) AND ((@IsNull_NombreCategoria = 1 AND [NombreCategoria] IS NULL) OR ([NombreCategoria] = @Original_NombreCategoria)));
SELECT CategoriaID, NombreCategoria FROM Categorias WHERE (CategoriaID = @CategoriaID)";
        ...
        public virtual int Fill(dsCategoria.CategoriasDataTable dataTable) {
        ...
        public virtual dsCategoria.CategoriasDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsCategoria.CategoriasDataTable dataTable = new dsCategoria.CategoriasDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsCategoria.CategoriasDataTable dataTable) {
