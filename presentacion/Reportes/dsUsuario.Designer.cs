...
namespace presentacion.Reportes {
    ...
    public partial class dsUsuario : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsuariosRow AddUsuariosRow(string NombreUsuario, string Correo, string Contraseña, string Rol, System.DateTime FechaCreacion) {
...
namespace presentacion.Reportes.dsUsuarioTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Usuarios] WHERE (([UsuarioID] = @Original_UsuarioID) AND ((@IsNull_NombreUsuario = 1 AND [NombreUsuario] IS NULL) OR ([NombreUsuario] = @Original_NombreUsuario)) AND ((@IsNull_Correo = 1 AND [Correo] IS NULL) OR ([Correo] = @Original_Correo)) AND ((@IsNull_Contraseña = 1 AND [Contraseña] IS NULL) OR ([Contraseña] = @Original_Contraseña)) AND ((@IsNull_Rol = 1 AND [Rol] IS NULL) OR ([Rol] = @Original_Rol)) AND ((@IsNull_FechaCreacion = 1 AND [FechaCreacion] IS NULL) OR ([FechaCreacion] = @Original_FechaCreacion)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Usuarios] ([NombreUsuario], [Correo], [Contraseña], [Rol], [FechaCreacion]) VALUES (@NombreUsuario, @Correo, @Contraseña, @Rol, @FechaCreacion);
SELECT UsuarioID, NombreUsuario, Correo, Contraseña, Rol, FechaCreacion FROM Usuarios WHERE (UsuarioID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuarios] SET [NombreUsuario] = @NombreUsuario, [Correo] = @Correo, [Contraseña] = @Contraseña, [Rol] = @Rol, [FechaCreacion] = @FechaCreacion WHERE (([UsuarioID] = @Original_UsuarioID) AND ((@IsNull_NombreUsuario = 1 AND [NombreUsuario] IS NULL) OR ([NombreUsuario] = @Original_NombreUsuario)) AND ((@IsNull_Correo = 1 AND [Correo] IS NULL) OR ([Correo] = @Original_Correo)) AND ((@IsNull_Contraseña = 1 AND [Contraseña] IS NULL) OR ([Contraseña] = @Original_Contraseña)) AND ((@IsNull_Rol = 1 AND [Rol] IS NULL) OR ([Rol] = @Original_Rol)) AND ((@IsNull_FechaCreacion = 1 AND [FechaCreacion] IS NULL) OR ([FechaCreacion] = @Original_FechaCreacion)));
SELECT UsuarioID, NombreUsuario, Correo, Contraseña, Rol, FechaCreacion FROM Usuarios WHERE (UsuarioID = @UsuarioID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UsuarioID, NombreUsuario, Correo, Contraseña, Rol, FechaCreacion FROM dbo." +
                "Usuarios";
        ...
        public virtual int Fill(dsUsuario.UsuariosDataTable dataTable) {
        ...
        public virtual dsUsuario.UsuariosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsUsuario.UsuariosDataTable dataTable) {
        ...
        public virtual int Delete(int Original_UsuarioID, string Original_NombreUsuario, string Original_Correo, string Original_Contraseña, string Original_Rol, global::System.Nullable<global::System.DateTime> Original_FechaCreacion) {
        ...
        public virtual int Insert(string NombreUsuario, string Correo, string Contraseña, string Rol, global::System.Nullable<global::System.DateTime> FechaCreacion) {
        ...
        public virtual int Update(string NombreUsuario, string Correo, string Contraseña, string Rol, global::System.Nullable<global::System.DateTime> FechaCreacion, int Original_UsuarioID, string Original_NombreUsuario, string Original_Correo, string Original_Contraseña, string Original_Rol, global::System.Nullable<global::System.DateTime> Original_FechaCreacion, int UsuarioID) {
            if ((NombreUsuario == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string NombreUsuario, string Correo, string Contraseña, string Rol, global::System.Nullable<global::System.DateTime> FechaCreacion, int Original_UsuarioID, string Original_NombreUsuario, string Original_Correo, string Original_Contraseña, string Original_Rol, global::System.Nullable<global::System.DateTime> Original_FechaCreacion) {
            return this.Update(NombreUsuario, Correo, Contraseña, Rol, FechaCreacion, Original_UsuarioID, Original_NombreUsuario, Original_Correo, Original_Contraseña, Original_Rol, Original_FechaCreacion, Original_UsuarioID);
        }
    }
